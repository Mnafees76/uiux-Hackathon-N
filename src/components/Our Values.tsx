export default function OurValues() {
    return (
      <main>
        <div className="w-full mt-5  max-w-screen-2xl mx-auto">
          <h1 className="text-4xl font-bold text-center">Our Values</h1>
          <div className="w-full flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-14 mx-3 mt-12">
            <div className="bg-yellow-50 w-full md:w-60 h-32 px-4 py-3">
